...
import { ArrowUpRight, ArrowLeft, ArrowRight, Video, FileText, Calendar, Mic, BookOpen } from 'lucide-react';
...
export const InsightsCarouselSection: React.FC = () => {
  const [activeTab, setActiveTab] = useState('White Papers');

  return (
    <section id="news-insights" style={{ backgroundColor: '#151347', color: '#ffffff', padding: '88px 0', position: 'relative' }}>
      <div className="container">
        ...
        {/* Carousel Grid flanked by Left/Right Arrow Controls (Matching Screenshot 3) */}
            ...
            {insightCards.map((card, i) => (
              ...
              >
                ...
                <div style={{ position: 'relative', height: '180px', overflow: 'hidden' }}>
                  ...
                  />
                  <div style={{ position: 'absolute', top: '12px', left: '12px', backgroundColor: 'rgba(44, 42, 117, 0.85)', backdropFilter: 'blur(4px)', color: '#f9b933', fontSize: '10px', fontWeight: 800, padding: '4px 10px', borderRadius: '4px', textTransform: 'uppercase' }}>
                    {card.category}
                  </div>
                </div>
                ...
                <div style={{ padding: '24px', flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <h3 style={{ fontSize: '18px', fontWeight: 800, color: 'var(--ink)', lineHeight: 1.35, marginBottom: '20px' }}>
                    {card.title}
                  </h3>
                  ...
                  >
                    ...
                    <ArrowUpRight size={16} style={{ color: 'var(--gold-strong)' }} />
                  </Link>
                </div>
              </div>
            ))}
        ...
        {/* Bottom 5-Filter Tab Bar (Matching Screenshot 3 Spec) */}
        <div style={{
